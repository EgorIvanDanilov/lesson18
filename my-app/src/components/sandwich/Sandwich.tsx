...
const Sandwich: FC = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <button
        className={cn(styles.btn, styles.btnBorder)}
        type="button"
        onClick={handleAddCheese}
      >
        добавить сыр
      </button>
      <button className={styles.btn} type="button" onClick={handleAddKolbasa}>
        добавить колбасу
      </button>
      <button className={styles.btn} type="button" onClick={handleClear}>
        готовить заново!
      </button>
    </div>
  );
